...
2. Fare clic sull' **+** sul lato destro per aggiungere una nuova parola chiave.
3. Digitare la parola chiave come **Move Astronaut**. Se lo si desidera, è possibile aggiungere un tasto di scelta rapida.
4. Fare clic sull' **+** sul lato destro per aggiungere una nuova parola chiave.
...
Complimenti. A questo punto è stato completato il **movimento Mr Input 211:** .
