...
### [Creazione di una galassia in realtà mista](case-study-creating-a-galaxy-in-mixed-reality.md)
...
### Attività iniziali
#### [Toolkit per realtà mista](mrtk-getting-started.md)
...
## Unreal
### Unreal per HoloLens 2 - presto disponibile!
## DirectX
...
#### [Sguardo fisso, movimenti e controller del movimento in DirectX](gaze,-gestures,-and-motion-controllers-in-directx.md)
...
## [Esercitazioni e app di esempio](academy.md)
### Unity
#### App di esempio open source
