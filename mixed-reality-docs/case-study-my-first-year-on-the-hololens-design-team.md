...
![il salto da 2D a 3D](images/2D_to_3D-800px.gif)<br>
*Salto da 2D a 3D*
...
![](images/bodylockedtagalong.gif) con blocco del corpo<br>
*Corpo-bloccato*

<br>

![](images/worldlocked.gif) con blocco globale<br>
*Con blocco globale*
...
Frammenti di ![-esempi di interfaccia utente di diegetica](images/fragments-game-example-1.jpg)<br>
...
![](images/job-simulator.gif) simulatore di processi<br>
...
![porta magica di Doraemon (a sinistra) e Ruby pantofole (destra)](images/doraemons-magical-door-and-ruby-slippers.jpg)<br>
