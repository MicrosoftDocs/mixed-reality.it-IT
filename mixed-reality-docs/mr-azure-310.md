...
## <a name="before-you-start"></a><span data-ttu-id="d2e8d-152">Prima di iniziare</span><span class="sxs-lookup"><span data-stu-id="d2e8d-152">Before you start</span></span>
...
7. <span data-ttu-id="d2e8d-235">In questo pannello, alcune impostazioni devono essere verificati:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-235">In this panel, a few settings need to be verified:</span></span>
    ...
    1.  <span data-ttu-id="d2e8d-236">Nel **altre impostazioni** scheda:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-236">In the **Other Settings** tab:</span></span>
        ...
        3. <span data-ttu-id="d2e8d-239">**Livello di compatibilità delle API** deve essere **.NET 4.6**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-239">**API Compatibility Level** should be **.NET 4.6**.</span></span>
...
<span data-ttu-id="d2e8d-290">Per creare questa classe:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-290">To create this class:</span></span>
...
## <a name="chapter-6---create-the-customvisionobjects-class"></a><span data-ttu-id="d2e8d-308">Capitolo 6: creare la classe CustomVisionObjects</span><span class="sxs-lookup"><span data-stu-id="d2e8d-308">Chapter 6 - Create the CustomVisionObjects class</span></span>
...
4.  <span data-ttu-id="d2e8d-329">Quindi, aggiungere le variabili seguenti all'interno di **SpatialMapping** classe, sopra il **Start ()** (metodo):</span><span class="sxs-lookup"><span data-stu-id="d2e8d-329">Then, add the following variables inside the **SpatialMapping** class, above the **Start()** method:</span></span>
...
6.  <span data-ttu-id="d2e8d-331">Eliminare il **Update ()** (metodo).</span><span class="sxs-lookup"><span data-stu-id="d2e8d-331">Delete the **Update()** method.</span></span>
...
7. <span data-ttu-id="d2e8d-344">Assicurarsi di salvare le modifiche apportate **Visual Studio**, prima di restituire **Unity**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-344">Be sure to save your changes in **Visual Studio**, before returning to **Unity**.</span></span>
...
8.  <span data-ttu-id="d2e8d-360">Aggiungere il **FinaliseLabel()** (metodo).</span><span class="sxs-lookup"><span data-stu-id="d2e8d-360">Add the **FinaliseLabel()** method.</span></span> <span data-ttu-id="d2e8d-361">È responsabile per:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-361">It is responsible for:</span></span>
...
10. <span data-ttu-id="d2e8d-367">Assicurarsi di salvare le modifiche apportate **Visual Studio**, prima di restituire **Unity**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-367">Be sure to save your changes in **Visual Studio**, before returning to **Unity**.</span></span>

    > [!IMPORTANT]
    > <span data-ttu-id="d2e8d-368">Prima di continuare, aprire il **CustomVisionAnalyser** (classe) e all'interno di **AnalyseLastImageCaptured()** metodo *rimuovere il commento* le righe seguenti:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-368">Before you continue, open the **CustomVisionAnalyser** class, and within the **AnalyseLastImageCaptured()** method, *uncomment* the following lines:</span></span>
    >
    >   ```csharp
    >   // Create a texture. Texture size does not matter, since 
    >   // LoadImage will replace with the incoming image size.
...
> [!NOTE]
> <span data-ttu-id="d2e8d-369">Senza doversi preoccupare di **ImageCapture** classe messaggio 'non è stato possibile trovare', si creerà nel capitolo successivo.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-369">Do not worry about the **ImageCapture** class 'could not be found' message, you will create it in the next chapter.</span></span>


## <a name="chapter-10---create-the-imagecapture-class"></a><span data-ttu-id="d2e8d-370">Capitolo 10 - creare la classe ImageCapture</span><span class="sxs-lookup"><span data-stu-id="d2e8d-370">Chapter 10 - Create the ImageCapture class</span></span>

<span data-ttu-id="d2e8d-371">La classe successiva si intende creare è il **ImageCapture** classe.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-371">The next class you are going to create is the **ImageCapture** class.</span></span>

<span data-ttu-id="d2e8d-372">Questa classe è responsabile per:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-372">This class is responsible for:</span></span>

*   <span data-ttu-id="d2e8d-373">Acquisizione di un'immagine usando la fotocamera di HoloLens e archiviandolo nel *App* cartella.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-373">Capturing an image using the HoloLens camera and storing it in the *App* folder.</span></span>
*   <span data-ttu-id="d2e8d-374">Gestisce *toccare* movimenti da parte dell'utente.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-374">Handling *Tap* gestures from the user.</span></span>

<span data-ttu-id="d2e8d-375">Per creare questa classe:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-375">To create this class:</span></span>

1.  <span data-ttu-id="d2e8d-376">Andare alla **script** cartella creata in precedenza.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-376">Go to the **Scripts** folder you created previously.</span></span>

2.  <span data-ttu-id="d2e8d-377">Fare doppio clic all'interno della cartella, quindi fare clic su **Create** > **C\# Script**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-377">Right-click inside the folder, then click **Create** > **C\# Script**.</span></span> <span data-ttu-id="d2e8d-378">Denominare lo script **ImageCapture**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-378">Name the script **ImageCapture**.</span></span>

3.  <span data-ttu-id="d2e8d-379">Fare doppio clic su nuova **ImageCapture** script per aprirlo con **Visual Studio.**</span><span class="sxs-lookup"><span data-stu-id="d2e8d-379">Double-click on the new **ImageCapture** script to open it with **Visual Studio.**</span></span>

4.  <span data-ttu-id="d2e8d-380">Sostituire gli spazi dei nomi nella parte superiore del file con il codice seguente:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-380">Replace the namespaces at the top of the file with the following:</span></span>
...
5.  <span data-ttu-id="d2e8d-381">Quindi aggiungere le variabili seguenti all'interno di **ImageCapture** classe sopra il **Start ()** metodo:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-381">Then add the following variables inside the **ImageCapture** class, above the **Start()** method:</span></span>
...
6.  <span data-ttu-id="d2e8d-382">Codice per un **Awake()** e **Start ()** metodi deve ora essere aggiunto:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-382">Code for **Awake()** and **Start()** methods now needs to be added:</span></span>
...
7.  <span data-ttu-id="d2e8d-383">Implementare un gestore che verrà chiamato quando si verifica un gesto tocco:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-383">Implement a handler that will be called when a Tap gesture occurs:</span></span>
    ...
    > [!IMPORTANT]
    > <span data-ttu-id="d2e8d-384">Quando il cursore si trova **verde**, significa che la fotocamera è disponibile per acquisire l'immagine.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-384">When the cursor is **green**, it means the camera is available to take the image.</span></span> <span data-ttu-id="d2e8d-385">Quando il cursore si trova **rosso**, significa che la fotocamera è occupata.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-385">When the cursor is **red**, it means the camera is busy.</span></span>

8.  <span data-ttu-id="d2e8d-386">Aggiungere il metodo che l'applicazione usa per avviare il processo di acquisizione di immagini e archiviare l'immagine:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-386">Add the method that the application uses to start the image capture process and store the image:</span></span>
...
9.  <span data-ttu-id="d2e8d-387">Aggiungere i gestori che verranno chiamati quando è stata acquisita la foto e quando è pronto per essere analizzati.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-387">Add the handlers that will be called when the photo has been captured and for when it is ready to be analyzed.</span></span> <span data-ttu-id="d2e8d-388">Il risultato viene quindi passato per il **CustomVisionAnalyser** per l'analisi.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-388">The result is then passed to the **CustomVisionAnalyser** for analysis.</span></span>
...
10. <span data-ttu-id="d2e8d-389">Assicurarsi di salvare le modifiche apportate **Visual Studio**, prima di restituire **Unity**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-389">Be sure to save your changes in **Visual Studio**, before returning to **Unity**.</span></span>

## <a name="chapter-11---setting-up-the-scripts-in-the-scene"></a><span data-ttu-id="d2e8d-390">Capitolo 11 - configurazione gli script nella scena</span><span class="sxs-lookup"><span data-stu-id="d2e8d-390">Chapter 11 - Setting up the scripts in the scene</span></span>

<span data-ttu-id="d2e8d-391">Ora che è necessario scrivere tutto il codice necessario per questo progetto, è ora possibile configurare gli script nella scena e su prefabs, per essi funzionino correttamente.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-391">Now that you have written all of the code necessary for this project, is time to set up the scripts in the scene, and on the prefabs, for them to behave correctly.</span></span>

1.  <span data-ttu-id="d2e8d-392">All'interno di **Editor di Unity**, nel **pannello gerarchia**, selezionare il **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-392">Within the **Unity Editor**, in the **Hierarchy Panel**, select the **Main Camera**.</span></span>
2.  <span data-ttu-id="d2e8d-393">Nel **Pannello di controllo**, con la **Main Camera** selezionato, fare clic su **Add Component**, quindi cercare **SceneOrganiser** script e Fare doppio clic, per aggiungerlo.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-393">In the **Inspector Panel**, with the **Main Camera** selected, click on **Add Component**, then search for **SceneOrganiser** script and double-click, to add it.</span></span>

    ![](images/AzureLabs-Lab310-38.png)

3.  <span data-ttu-id="d2e8d-394">Nel **pannello progetto**, aprire il **cartella Prefabs**, trascinare il **etichetta** prefab nel *etichetta* area di input destinazione del riferimento vuoto nel **SceneOrganiser** che appena aggiunti allo script il *Main Camera*, come illustrato nell'immagine seguente:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-394">In the **Project Panel**, open the **Prefabs folder**, drag the **Label** prefab into the *Label* empty reference target input area, in the **SceneOrganiser** script that you have just added to the *Main Camera*, as shown in the image below:</span></span>

    ![](images/AzureLabs-Lab310-39.png)

4.  <span data-ttu-id="d2e8d-395">Nel **Pannello di gerarchia**, selezionare la **GazeCursor** figlio del **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-395">In the **Hierarchy Panel**, select the **GazeCursor** child of the **Main Camera**.</span></span>
5.  <span data-ttu-id="d2e8d-396">Nel **Pannello di controllo**, con la **GazeCursor** selezionato, fare clic su **Add Component**, quindi cercare **GazeCursor** script e Fare doppio clic, per aggiungerlo.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-396">In the **Inspector Panel**, with the **GazeCursor** selected, click on **Add Component**, then search for **GazeCursor** script and double-click, to add it.</span></span>

    ![](images/AzureLabs-Lab310-40.png)

6.  <span data-ttu-id="d2e8d-397">Ripetere l'operazione, il **pannello gerarchia**, selezionare il **SpatialMapping** figlio del **Main Camera**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-397">Again, in the **Hierarchy Panel**, select the **SpatialMapping** child of the **Main Camera**.</span></span>
7.  <span data-ttu-id="d2e8d-398">Nel **Pannello di controllo**, con la **SpatialMapping** selezionato, fare clic su **Add Component**, quindi cercare **SpatialMapping** script e fare doppio clic, per aggiungerlo.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-398">In the **Inspector Panel**, with the **SpatialMapping** selected, click on **Add Component**, then search for **SpatialMapping** script and double-click, to add it.</span></span>

    ![](images/AzureLabs-Lab310-41.png)

<span data-ttu-id="d2e8d-399">Gli script rimanenti che si hanno non verrà aggiunti dal codice nel set il **SceneOrganiser** script, in fase di esecuzione.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-399">The remaining scripts thats you have not set will be added by the code in the **SceneOrganiser** script, during runtime.</span></span>

## <a name="chapter-12---before-building"></a><span data-ttu-id="d2e8d-400">Capitolo 12 - prima della compilazione</span><span class="sxs-lookup"><span data-stu-id="d2e8d-400">Chapter 12 - Before building</span></span>

<span data-ttu-id="d2e8d-401">Per eseguire un test approfondito dell'applicazione sarà necessario per effettuare il sideload in di Microsoft HoloLens.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-401">To perform a thorough test of your application you will need to sideload it onto your Microsoft HoloLens.</span></span>

<span data-ttu-id="d2e8d-402">Prima di procedere, verificare quanto segue:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-402">Before you do, ensure that:</span></span>

-  <span data-ttu-id="d2e8d-403">Tutte le impostazioni indicate nella [capitolo 3](#chapter-3---set-up-the-unity-project) siano impostate correttamente.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-403">All the settings mentioned in the [Chapter 3](#chapter-3---set-up-the-unity-project) are set correctly.</span></span>
- <span data-ttu-id="d2e8d-404">Lo script **SceneOrganiser** è collegato il **Main Camera** oggetto.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-404">The script **SceneOrganiser** is attached to the **Main Camera** object.</span></span>
- <span data-ttu-id="d2e8d-405">Lo script **GazeCursor** è collegato il **GazeCursor** oggetto.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-405">The script **GazeCursor** is attached to the **GazeCursor** object.</span></span>
- <span data-ttu-id="d2e8d-406">Lo script **SpatialMapping** è collegato il **SpatialMapping** oggetto.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-406">The script **SpatialMapping** is attached to the **SpatialMapping** object.</span></span>
- <span data-ttu-id="d2e8d-407">Nelle [capitolo 5](#chapter-5---create-the-customvisionanalyser-class), passaggio 6:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-407">In [Chapter 5](#chapter-5---create-the-customvisionanalyser-class), Step 6:</span></span>

    - <span data-ttu-id="d2e8d-408">Assicurarsi di inserire le **chiave del servizio stima** nel **predictionKey** variabile.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-408">Make sure you insert your **Service Prediction Key** into the **predictionKey** variable.</span></span>
    - <span data-ttu-id="d2e8d-409">Sono stati inseriti i **Endpoint di stima** nel **predictionEndpoint** classe.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-409">You have inserted your **Prediction Endpoint** into the **predictionEndpoint** class.</span></span>

## <a name="chapter-13---build-the-uwp-solution-and-sideload-your-application"></a><span data-ttu-id="d2e8d-410">Capitolo 13 - compila la soluzione di piattaforma UWP e trasferire localmente l'applicazione</span><span class="sxs-lookup"><span data-stu-id="d2e8d-410">Chapter 13 - Build the UWP solution and sideload your application</span></span>

<span data-ttu-id="d2e8d-411">A questo punto si è pronti a compilare l'applicazione come una soluzione di piattaforma UWP potrai distribuire con il Microsoft HoloLens è.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-411">You are now ready to build you application as a UWP Solution that you will be able to deploy on to the Microsoft HoloLens.</span></span> <span data-ttu-id="d2e8d-412">Per iniziare il processo di compilazione:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-412">To begin the build process:</span></span>

1.  <span data-ttu-id="d2e8d-413">Passare a **File > Impostazioni di compilazione**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-413">Go to **File > Build Settings**.</span></span>

2.  <span data-ttu-id="d2e8d-414">Segni di graduazione **Unity C\# progetti**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-414">Tick **Unity C\# Projects**.</span></span>

3.  <span data-ttu-id="d2e8d-415">Fare clic su **aggiungere scene Open**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-415">Click on **Add Open Scenes**.</span></span> <span data-ttu-id="d2e8d-416">Verrà aggiunta la scena attualmente aperta per la compilazione.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-416">This will add the currently open scene to the build.</span></span>

    ![](images/AzureLabs-Lab310-42.png)

4.  <span data-ttu-id="d2e8d-417">Fai clic su **Compila**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-417">Click **Build**.</span></span> <span data-ttu-id="d2e8d-418">Unity avvierà una *Esplora File* finestra, in cui è necessario creare e quindi selezionare una cartella per compilare l'app in.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-418">Unity will launch a *File Explorer* window, where you need to create and then select a folder to build the app into.</span></span> <span data-ttu-id="d2e8d-419">Creare ora tale cartella e denominarlo **App**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-419">Create that folder now, and name it **App**.</span></span> <span data-ttu-id="d2e8d-420">Quindi con il **App** cartella selezionata, fare clic su **Seleziona cartella**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-420">Then with the **App** folder selected, click **Select Folder**.</span></span>

5.  <span data-ttu-id="d2e8d-421">Unity verrà avviata la compilazione del progetto per la **App** cartella.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-421">Unity will begin building your project to the **App** folder.</span></span>

6.  <span data-ttu-id="d2e8d-422">Una volta Unity ha terminato predefiniti (potrebbe richiedere alcuni minuti), si aprirà un **Esplora File** finestra in corrispondenza della posizione della compilazione (controllare la barra delle applicazioni, essendo, ma potrebbe non venire visualizzato di sopra di notifica di aggiunta di un nuovo finestra).</span><span class="sxs-lookup"><span data-stu-id="d2e8d-422">Once Unity has finished building (it might take some time), it will open a **File Explorer** window at the location of your build (check your task bar, as it may not always appear above your windows, but will notify you of the addition of a new window).</span></span>

7.  <span data-ttu-id="d2e8d-423">Per distribuire al Microsoft HoloLens, è necessario l'indirizzo IP del dispositivo (per la distribuzione remota), e per verificare che siano anche dispone **modalità sviluppatore** impostato.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-423">To deploy on to Microsoft HoloLens, you will need the IP Address of that device (for Remote Deploy), and to ensure that it also has **Developer Mode** set.</span></span> <span data-ttu-id="d2e8d-424">A tale scopo, effettuare le seguenti operazioni:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-424">To do this:</span></span>

    1.  <span data-ttu-id="d2e8d-425">Durante l'uso di HoloLens, aprire il **impostazioni**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-425">Whilst wearing your HoloLens, open the **Settings**.</span></span>

    2.  <span data-ttu-id="d2e8d-426">Passare a **rete e Internet** > **Wi-Fi** > **opzioni avanzate**</span><span class="sxs-lookup"><span data-stu-id="d2e8d-426">Go to **Network & Internet** > **Wi-Fi** > **Advanced Options**</span></span>

    3.  <span data-ttu-id="d2e8d-427">Si noti il **IPv4** indirizzo.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-427">Note the **IPv4** address.</span></span>

    4.  <span data-ttu-id="d2e8d-428">Successivamente, tornare **le impostazioni**e quindi a **aggiornamento e sicurezza** > **per gli sviluppatori**</span><span class="sxs-lookup"><span data-stu-id="d2e8d-428">Next, navigate back to **Settings**, and then to **Update & Security** > **For Developers**</span></span>

    5.  <span data-ttu-id="d2e8d-429">Impostare **modalità sviluppatore** *su*.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-429">Set **Developer Mode** *On*.</span></span>

8.  <span data-ttu-id="d2e8d-430">Passare alla nuova build Unity (le **App** cartella) e aprire il file di soluzione con **Visual Studio**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-430">Navigate to your new Unity build (the **App** folder) and open the solution file with **Visual Studio**.</span></span>

9.  <span data-ttu-id="d2e8d-431">Selezione configurazione di soluzione **Debug**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-431">In the Solution Configuration select **Debug**.</span></span>

10. <span data-ttu-id="d2e8d-432">La piattaforma della soluzione, selezionare **x86, computer remoto**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-432">In the Solution Platform, select **x86, Remote Machine**.</span></span> <span data-ttu-id="d2e8d-433">Verrà richiesto di inserire le **indirizzo IP** di un dispositivo remoto (di Microsoft HoloLens, in questo caso, che si è preso nota).</span><span class="sxs-lookup"><span data-stu-id="d2e8d-433">You will be prompted to insert the **IP address** of a remote device (the Microsoft HoloLens, in this case, which you noted).</span></span>

    ![](images/AzureLabs-Lab310-43.png)

11. <span data-ttu-id="d2e8d-434">Andare alla **compilare** dal menu e fare clic su **Distribuisci soluzione** trasferire localmente l'applicazione di HoloLens.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-434">Go to the **Build** menu and click on **Deploy Solution** to sideload the application to your HoloLens.</span></span>

12. <span data-ttu-id="d2e8d-435">L'app deve vengono ora visualizzati nell'elenco delle App installate in di Microsoft HoloLens, pronta per essere avviata.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-435">Your app should now appear in the list of installed apps on your Microsoft HoloLens, ready to be launched!</span></span>

### <a name="to-use-the-application"></a><span data-ttu-id="d2e8d-436">Per usare l'applicazione:</span><span class="sxs-lookup"><span data-stu-id="d2e8d-436">To use the application:</span></span>

* <span data-ttu-id="d2e8d-437">Esaminare un oggetto che aver eseguito il training con il **servizio visione artificiale personalizzato di Azure, rilevamento di oggetti**e utilizzare il **gesto tocco**.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-437">Look at an object, which you have trained with your **Azure Custom Vision Service, Object Detection**, and use the **Tap gesture**.</span></span>
* <span data-ttu-id="d2e8d-438">Se l'oggetto è stato rilevato, un spazio globale *testo dell'etichetta* verranno visualizzate con il nome del tag.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-438">If the object is successfully detected, a world-space *Label Text* will appear with the tag name.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="d2e8d-439">Ogni volta che è acquisire una foto e inviarlo al servizio, è possibile tornare alla pagina del servizio e ripetere il training del servizio con le immagini appena acquisite.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-439">Every time you capture a photo and send it to the Service, you can go back to the Service page and retrain the Service with the newly captured images.</span></span> <span data-ttu-id="d2e8d-440">All'inizio, sarà probabilmente anche essere necessario correggere il *riquadri* per ottenere una maggiore precisione e ripetere il training del servizio.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-440">At the beginning, you will probably also have to correct the *Bounding Boxes* to be more accurate and retrain the Service.</span></span>

> [!NOTE]
> <span data-ttu-id="d2e8d-441">Il testo dell'etichetta inseriti potrebbe non essere visualizzato in prossimità dell'oggetto quando i sensori Microsoft HoloLens e/o SpatialTrackingComponent in Unity non è possibile posizionare il colliders appropriato, rispetto all'oggetto reale.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-441">The Label Text placed might not appear near the object when the Microsoft HoloLens sensors and/or the SpatialTrackingComponent in Unity fails to place the appropriate colliders, relative to the real world objects.</span></span> <span data-ttu-id="d2e8d-442">Provare a usare l'applicazione in un'area diversa, se in questo caso.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-442">Try to use the application on a different surface if that is the case.</span></span>

## <a name="your-custom-vision-object-detection-application"></a><span data-ttu-id="d2e8d-443">La visione artificiale personalizzato, applicazione di rilevamento di oggetti</span><span class="sxs-lookup"><span data-stu-id="d2e8d-443">Your Custom Vision, Object Detection application</span></span>

<span data-ttu-id="d2e8d-444">Complimenti, è stata compilata un'app per realtà mista che sfrutta la visione personalizzata di Azure, API di rilevamento di oggetti, che può riconoscere un oggetto da un'immagine e quindi specificare una posizione approssimativa per quell'oggetto nello spazio 3D.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-444">Congratulations, you built a mixed reality app that leverages the Azure Custom Vision, Object Detection API, which can recognize an object from an image, and then provide an approximate position for that object in 3D space.</span></span>

![](images/AzureLabs-Lab310-00.png)

## <a name="bonus-exercises"></a><span data-ttu-id="d2e8d-445">Esercizi bonus</span><span class="sxs-lookup"><span data-stu-id="d2e8d-445">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="d2e8d-446">Esercizio 1</span><span class="sxs-lookup"><span data-stu-id="d2e8d-446">Exercise 1</span></span>

<span data-ttu-id="d2e8d-447">Aggiunta all'etichetta di testo, utilizzare un cubo semi-trasparente per eseguire il wrapping dell'oggetto reale in una 3D *rettangolo di selezione*.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-447">Adding to the Text Label, use a semi-transparent cube to wrap the real object in a 3D *Bounding Box*.</span></span>

### <a name="exercise-2"></a><span data-ttu-id="d2e8d-448">Esercizio 2</span><span class="sxs-lookup"><span data-stu-id="d2e8d-448">Exercise 2</span></span>

<span data-ttu-id="d2e8d-449">Eseguire il training del servizio visione artificiale personalizzato per riconoscere più oggetti.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-449">Train your Custom Vision Service to recognize more objects.</span></span>

### <a name="exercise-3"></a><span data-ttu-id="d2e8d-450">Esercizio 3</span><span class="sxs-lookup"><span data-stu-id="d2e8d-450">Exercise 3</span></span>

<span data-ttu-id="d2e8d-451">Riprodurre un suono quando un oggetto viene riconosciuto.</span><span class="sxs-lookup"><span data-stu-id="d2e8d-451">Play a sound when an object is recognized.</span></span>

### <a name="exercise-4"></a><span data-ttu-id="d2e8d-452">Esercizio 4</span><span class="sxs-lookup"><span data-stu-id="d2e8d-452">Exercise 4</span></span>

<span data-ttu-id="d2e8d-453">Usare l'API di eseguire nuovamente il training del servizio con le stesse immagini all'app è l'analisi, pertanto, per rendere il più accurati (eseguire stime e contemporaneamente di training).</span><span class="sxs-lookup"><span data-stu-id="d2e8d-453">Use the API to re-train your Service with the same images your app is analyzing, so to make the Service more accurate (do both prediction and training simultaneously).</span></span>
