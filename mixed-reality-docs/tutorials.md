...
<ul id="cardtypes-W" class="cardsW panelContent" style="display: flex; margin-top: 0px;">
                            <li>
                                    <a href="holograms-100.md" title="Nozioni di base MR 100" data-linktype="absolute-path">
                                    <div class="cardSize">
                            ...
                            <li>
                                  <a href="holograms-101.md" title="Nozioni di base MR 101" data-linktype="absolute-path">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                                <a href="holograms-101e.md" title="Nozioni di base MR 101E" data-linktype="absolute-path">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                            ...
                            <li>
                             <a href="holograms-210.md" title="Input MR 210" data-linktype="absolute-path">
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <p>Lo sguardo è la prima forma di input e rivela la finalità e la consapevolezza dell'utente. Aggiungerai la consapevolezza contestuale al cursore e agli ologrammi, sfruttando appieno i vantaggi di ciò che l'app conosce in merito allo sguardo dell'utente.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                            ...
                            <li>
                            <a href="holograms-211.md" title="Input MR 211" data-linktype="absolute-path">
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                              ...
                                              <p>I movimenti attivano l'azione dell'utente. Grazie ai movimenti, gli utenti possono interagire con gli ologrammi. In questo corso imparerai a tracciare le mani dell'utente, rispondere al suo input e fornire feedback in base allo stato e alla posizione della mano.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                            ...
                            <li>
                             <a href="holograms-212.md" title="Input MR 212" data-linktype="absolute-path">
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                             ...
                             <li>
                              <a href="mixed-reality-213.md" title="Input MR 213" data-linktype="absolute-path">
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                              <h3>Input MR 213: Controller del movimento</h3>
                                              <p>Questo corso analizza le modalità di visualizzazione dei controller del movimento in visori VR immersive, la gestione degli eventi di input e l'associazione di elementi dell'interfaccia utente personalizzati ai controller.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <li>
                              <a href="holograms-220.md" title="Spaziale MR 220" data-linktype="absolute-path">
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                              <h3>Spaziale MR 220: Audio spaziale</h3>
                                              <p>L'audio spaziale ha l'effetto di rendere vivi gli ologrammi e identificare la loro presenza. In questo corso imparerai a usare l'audio spaziale per gli ologrammi di base nel mondo circostante, fornire feedback durante le interazioni e usare l'audio per trovare gli ologrammi.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                               ...
                               <li>
                               <a href="holograms-230.md" title="Spaziale MR 230" data-linktype="absolute-path">
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                                          ...
                                          <div class="cardText">
                                              <h3>Spaziale MR 230: Mapping spaziale</h3>
                                              <p>Il mapping spaziale mette insieme il mondo reale con quello virtuale. Avrai la possibilità di esplorare gli shader e usarli per visualizzare lo spazio. Apprenderai quindi a semplificare la mesh della stanza in semplici piani, fornire feedback su come posizionare gli ologrammi sulle superfici reali ed esplorare gli effetti visivi di occlusione.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>Condivisione MR 240: Più dispositivi HoloLens</h3>
                                              <p>Questo è il nostro progetto //Build 2016. Configura un progetto completo con sistemi di coordinate condivisi tra dispositivi HoloLens, consentendo agli utenti di partecipare a un mondo olografico condiviso.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>Condivisione MR 250: HoloLens e visori VR immersivi</h3>
                                              <p>Nel progetto //Build 2017 illustriamo la creazione di un'app che sfrutta i vantaggi esclusivi di HoloLens e dei visori VR immersive in un'esperienza condivisa da più dispositivi.</p>
                                          </div>
                                      </div>
                                  </div>
                              </div>
