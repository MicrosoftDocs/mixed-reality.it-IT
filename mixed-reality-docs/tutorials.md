...
Le esercitazioni di HoloLens 2 sono state realizzate per aiutare gli sviluppatori ad apprendere le tecniche e le procedure consigliate per sviluppare applicazioni di realtà mista.  Le esercitazioni sono basate sul [Toolkit di realtà misto 2,0 (MRTK 2,0)](https://github.com/microsoft/MixedRealityToolkit-Unity).
...
* Esercitazioni su servizi vocali di Azure- [1 di 4 integrazione e uso del riconoscimento vocale e della trascrizione](mrlearning-speechSDK-ch1.md)
...
* Le esercitazioni coprono gli argomenti relativi a 100, 200 e 300, in cui il livello 100 copre le nozioni di base del progetto, il livello di 200 riguarda i blocchi predefiniti di base e il livello di 300 riguarda l'integrazione dei servizi cloud.
...
<ul id="cardtypes-W" class="cardsW panelContent" style="display: flex; margin-top: 0px;">
                            <li>
                                    <a href="holograms-100.md" title="MR nozioni di base 100" data-linktype="absolute-path">
                                    <div class="cardSize">
                            ...
                            <li>
                                  <a href="holograms-101.md" title="MR nozioni di base 101" data-linktype="absolute-path">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                ...
                                                <div class="cardText">
                                                    <h3>Nozioni fondamentali 101: completare il progetto con il dispositivo</h3>
                            ...
                            <li>
                                <a href="holograms-101e.md" title="MR nozioni di base 101E" data-linktype="absolute-path">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                <div class="cardImageOuter">
                                                ...
                                                <div class="cardText">
                                                    <h3>Nozioni di base su 101E: completare il progetto con l'emulatore</h3>
                            ...
                            <li>
                             ...
                             <li>
                              ...
                              <li>
                              <a href="holograms-220.md" title="" data-linktype="absolute-path">Spatial 220 
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                               ...
                               <li>
                               <a href="holograms-230.md" title="" data-linktype="absolute-path">Spatial 230 
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          <div class="cardImageOuter">
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>MR e Azure 301: traduzione in lingua</h3>
                              ...
                              <div class="cardSize">
                                  <div class="cardPadding">
                                      <div class="card">
                                          ...
                                          <div class="cardText">
                                              <h3>MR e Azure 313: servizio hub Internet</h3>
