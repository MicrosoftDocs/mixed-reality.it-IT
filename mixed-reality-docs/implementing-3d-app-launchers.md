...
1. Valore predefinito: Quando un utente seleziona il secondaryTile 3D, l'app viene attivata
2. None: Quando gli utenti selezionano il secondaryTile 3D non accade nulla e l'app non è attivata.
