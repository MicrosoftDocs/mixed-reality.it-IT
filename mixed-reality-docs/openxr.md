...
Entro il 2020 luglio, il runtime di OpenXR per la realtà mista di Windows supporterà un set di `MSFT` `EXT` estensioni e che porteranno il set completo di funzionalità HoloLens 2 alle applicazioni OpenXR:
...
| Integrazione con Direct3D 12 | **`KHR`Estensione ufficiale nel [runtime di anteprima 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_KHR_D3D12_enable" target="_blank">XR_KHR_D3D12_enable</a></code><br /><p>**Supporto in fase di esecuzione stabile**: 2020 maggio *(pianificato)*</p> |
...
| [Articolazione manuale + mesh mano](hands-and-tools.md)<p>*Solo HoloLens 2*</p> | **`MSFT_preview`estensioni nel [runtime di anteprima 2001](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_preview">XR_MSFT_hand_tracking_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_hand_tracking_mesh_preview">XR_MSFT_hand_tracking_mesh_preview</a></code><p>** `MSFT` `EXT` estensione o nel runtime di anteprima**: 2020 maggio *(pianificato)*</p> |
| [Tracciamento oculare](eye-tracking.md)<p>*Solo HoloLens 2*</p> | ** `EXT` estensione nel [runtime di anteprima 2003](openxr-getting-started.md#using-preview-extensions)**:<br /><code><a href="https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XR_EXT_eye_gaze_interaction" target="_blank">XR_EXT_eye_gaze_interaction</a></code><p>**Supporto in fase di esecuzione stabile**: 2020 maggio *(pianificato)*</p> |
| Interoperabilità con altri SDK di HoloLens (ad esempio, [QR](qr-code-tracking.md))<p>*Solo HoloLens 2*</p> | **`MSFT_preview`estensione nel [runtime di anteprima 2001](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_spatial_graph_bridge_preview">XR_MSFT_spatial_graph_bridge_preview</a></code><p>** `MSFT` estensione nel runtime di anteprima**: 2020 maggio *(pianificato)*</p> |
| [Acquisizione di realtà mista <br /> (terzo rendering dalla fotocamera FV)](mixed-reality-capture-for-developers.md#render-from-the-pv-camera-opt-in)<p>*Solo HoloLens 2*</p> | **`MSFT_preview`estensioni nel [runtime di anteprima 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_secondary_view_configuration_preview">XR_MSFT_secondary_view_configuration_preview</a></code><br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_first_person_observer_preview">XR_MSFT_first_person_observer_preview</a></code><p>** `MSFT` estensione nel runtime di anteprima**: giugno 2020 *(pianificato)*</p> |
| [Modelli di rendering del controller di movimento](motion-controllers.md#rendering-the-motion-controller-model) | **`MSFT_preview`estensione nel [runtime di anteprima 2003](openxr-getting-started.md#using-preview-extensions):**<br /><code><a href="https://microsoft.github.io/OpenXR-MixedReality/openxr_preview/specs/openxr.html#XR_MSFT_controller_model_preview">XR_MSFT_controller_model_preview</a></code><p>** `MSFT` estensione nel runtime di anteprima**: 2020 luglio *(pianificato)*</p> |
| [Comprensione della scena (piani, mesh)](scene-understanding.md)<p>*Solo HoloLens 2*</p> | <p>** `MSFT_preview` estensione nel runtime di anteprima**: giugno 2020 *(pianificato)*</p><p>** `MSFT` estensione nel runtime di anteprima**: 2020 luglio *(pianificato)*</p> |
