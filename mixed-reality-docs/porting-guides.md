...
La piattaforma di realtà mista Windows è ancora in fase di sviluppo attivo e, per maggiore efficienza, è consigliabile usare il volo "Windows Insider Fast". Per avere accesso ai voli di Windows, sarà necessario [partecipare al programma Windows Insider](https://insider.windows.com/).
...
4. Passa a [collegamenti rapidi di Windows Insider](https://blogs.technet.microsoft.com/uktechnet/2016/07/01/joining-insider-preview) tramite impostazioni-> sezione aggiornamento & sicurezza
...
### <a name="common-step-4-be-ready-for-the-store"></a>Passaggio 4 comune: pronto per lo Store
...
5. Controllare e verificare se sono presenti ulteriori modifiche che è necessario apportare per eseguire il progetto e risolvere gli eventuali errori e avvisi rimanenti. Nota: se si ha un middleware da cui dipendere, potrebbe essere necessario aggiornare il middleware per procedere (altri dettagli nel passaggio 3 riportato di seguito).
